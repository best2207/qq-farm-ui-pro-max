...
echo ""
echo "ARM 服务器:"
echo "  curl -O https://raw.githubusercontent.com/smdk000/qq-farm-ui-pro-max/main/scripts/deploy-arm.sh"
echo "  chmod +x deploy-arm.sh"
echo "  ./deploy-arm.sh"
echo ""
echo "x86 服务器:"
echo "  curl -O https://raw.githubusercontent.com/smdk000/qq-farm-ui-pro-max/main/scripts/deploy-x86.sh"
